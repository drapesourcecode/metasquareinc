<template>
  <main>
    ...
    <section
      ...
      style="background-image: url(/assets/img/bg/bdrc-bg.jpg)"
    >
    ...
    <!-- map-area-end -->
    <section
      class="team-area2 fix p-relative pt-90 pb-80"
        ...
        <!-- <div class="row">   
                        <div class="col-lg-12 p-relative">
                           <div class="section-title center-align mb-50 text-center wow fadeInDown animated" data-animation="fadeInDown" data-delay=".4s">
                                <h2>Our <span style="color: #fe7425;">Offices</span></h2>
                            </div>
                        </div>  -->
      </div>
      <div class="elementor-widget-wrap elementor-element-populated">
        <div
          class="elementor-element elementor-element-69e9a4c elementor-widget elementor-widget-text-editor"
          data-id="69e9a4c"
        ...
        >
          <div class="elementor-widget-container">
            ...
            Welcome to Metasquareinc!These terms and conditions outline the
            rules and regulations for the use of Metasquareinc’s Website,
            located at https://www.metasquareinc.com/.By accessing this website
            we assume you accept these terms and conditions. Do not continue to
            use Metasquareinc if you do not agree to take all of the terms and
            ...
            We employ the use of cookies. By accessing Metasquareinc, you agreed
            to use cookies in agreement with the Metasquareinc’s Privacy
            ...
            Unless otherwise stated, Metasquareinc and/or its licensors own the
            intellectual property rights for all material on Metasquareinc. All
            intellectual property rights are reserved. You may access this from
            Metasquareinc for your own personal use subjected to restrictions
            set in these terms and conditions.You must not:
            <ul>
              <li>Republish material from Metasquareinc</li>
              <li>Sell, rent or sub-license material from Metasquareinc</li>
              <li>Reproduce, duplicate or copy material from Metasquareinc</li>
              <li>Redistribute content from Metasquareinc</li>
            </ul>
            ...
            Metasquareinc does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Metasquareinc,its agents and/or affiliates.
            ...
            Metasquareinc shall not be liable for the Comments or for any
            ...
            this website.Metasquareinc reserves the right to monitor all
            ...
            You hereby grant Metasquareinc a non-exclusive license to use,
            ...
            Metasquareinc; and (d) the link is in the context of general
            resource information.These organizations may link to our home page
            so long as the link: (a) is not in any way deceptive; (b) does not
            falsely imply sponsorship, endorsement or approval of the linking
            party and its products or services; and (c) fits within the context
            of the linking party’s site.If you are one of the organizations
            listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to Metasquareinc.
            ...
            response.Approved organizations may hyperlink to our Website as
            follows:
            <ul>
            ...
            No use of Metasquareinc’s logo or other artwork will be allowed for
            ...
            <h3><strong>Contact Information &amp; SMS Terms</strong></h3>
            By providing your phone number, you consent to receive text messages
            from Metasquareinc. Message and data rates may apply. Message
            frequency may vary. To stop receiving messages, reply ‘STOP’ at any
            time. For more information, reply ‘HELP’.&nbsp;<strong
              ><a href="https://www.metasquareinc.com/privacy-policy"
                >Privacy Policy</a
              ></strong
            >&nbsp;|&nbsp;<a
              href="https://www.metasquareinc.com/terms-and-conditions/"

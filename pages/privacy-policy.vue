  ...
  <main>
    ...
    >
      <div class="elementor-widget-wrap elementor-element-populated">
        <div
          class="elementor-element elementor-element-46541bc8 elementor-widget elementor-widget-text-editor"
          data-id="46541bc8"
          ...
          <div class="elementor-widget-container">
            <p>
              <em
                ...
                parties/affiliates marketing/promotional purposes. All the above
                categories exclude text messaging originator opt-in data and
                consent; this information will not be shared with any third
                parties. If you wish to be removed from receiving future
                communications, you can opt out by replying STOP to the message
                you received from us, or by clicking here to&nbsp;<a
                  href="https://www.tekinspirations.com/unsubscribe/"
                  >Unsubscribe</a
                >.</em
              >
            </p>
